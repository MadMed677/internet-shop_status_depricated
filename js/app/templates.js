define([
	...
	Templates['basket'] = [
		'<div class="col-xs-12 condom-view condom-view-basket">',
			...
			'<div class="col-xs-4">',
				...
				'<span class="price-basket"><%= price %></span>',
				'<i class="fa fa-rub"></i>',
			'</div>',
			'<div class="col-xs-2 line-height-basket">',
				'=',
				'<span class="total-count-basket"><%= total %></span>',
				'<i class="fa fa-rub"></i>',
			'</div>',
